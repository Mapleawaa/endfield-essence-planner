window.CONTENT = {
  announcement: {
    ...
    items: [
      "感谢大家的支持与喜爱~(感谢岷叔的宣传~)",
      "由于先前缓存配置错误,如果你的图片加载异常,请清除网站缓存后等待10秒刷新一次即可",
      "嗯...界面加了一些新内容...都应当不会影响使用的...如有UI错位请前往GitHub或群内反馈",
      "关于角色攻略,页面正在制作中~感谢[@克劳德的第九艺术世界](https://space.bilibili.com/209712)提供文案支持",
    ],
  },
  changelog: {
    title: "更新日志",
